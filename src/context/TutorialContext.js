  ...
  home: [
    {
      ...
      icon: 'List',
      title: 'Your habits',
      body: "Use the type chips to filter by Start (habits to build), Stop (habits to break), or Neutral (things to track). Category chips appear once you have categorised habits. The grid/list toggle in the top-right switches your view layout.",
      type: 'intro',
    },
    {
      id: 'new_habit_info',
